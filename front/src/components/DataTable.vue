    ...
    .map(raw => {
      switch (raw) {
        case "firstName": return {
          id: "firstName", name: "First Name", width: "w-2/12"
        }
        case "lastName": return {
          id: "lastName", name: "Last Name", width: "w-2/12"
        }
        case "email": return {
          id: "email", name: "Email", width: "w-3/12"
        }
        case "level": return {
          id: "level", name: "Level", width: "w-2/12"
        }
        case "serviceType": return {
          id: "serviceType", name: "Service", width: "w-2/12"
        }
        case "rate": return {
          id: "rate", name: "Rate (USD)", width: "w-2/12"
        }
        case "tags": return {
          id: "tags",
          name: "Tags",
        ...
        case "paymentMethod": return {
          id: "paymentMethod", name: "Payment Methods", width: "w-2/12",
          formatter: (cell, row, column) => {
